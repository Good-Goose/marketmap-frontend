...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-lg font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-tr from-[#0E63AF] to-[#007BFF] text-background hover:from-[#001AFF] hover:to-[#005CFF] active:from-[#003299] active:to-[#003299] uppercase',
        destructive:
        ...
        link: 'text-primary-foreground  underline-offset-4 hover:underline hover:text-foreground ',
      },
      size: {
        default: 'px-6 py-4',
        none: 'p-0',
        full: 'w-full px-4 py-2',
        large: 'h-16 px-12 py-4',
        icon: 'h-10 w-10',
      },
    },
    defaultVariants: {
